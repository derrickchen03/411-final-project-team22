...
def test_create_user(sample_user):
    ...
    user = User.query(User).filter_by(username=sample_user["username"]).first()
...
def test_check_password_correct(sample_user):
...
def test_check_password_incorrect(sample_user):
